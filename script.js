...
const collegeTimeCard = document.querySelector(".college-time-card")?.closest(".work-card");
...
if (collegeTimeCard) {
    collegeTimeCard.addEventListener("click", () => {
        window.open("college-time.html", "_blank", "noopener,noreferrer");
    });
}
